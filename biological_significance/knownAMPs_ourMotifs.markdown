...
**eye candy:** Figure 9 contains a nice 3-dimentional model of the conformation the peptide takes when interacting with a micel (a small bubble of surfactant). The micel was not actually made out of bacterial molecules, rather, it was a type of surfactant called DPC that is commonly used in bio-membrane studies. More information on DPC can be found [here](https://pubs.acs.org/doi/10.1021/acs.langmuir.5b02077) and [here](https://en.wikipedia.org/wiki/Phosphocholine).
